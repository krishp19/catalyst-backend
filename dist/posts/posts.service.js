...
let PostsService = class PostsService {
    constructor(postsRepository, votesRepository, communitiesService, tagsService, reputationService, notificationsService) {
    ...
    async update(id, updatePostDto, user) {
        ...
        if ('type' in updatePostDto) {
            this.validatePostData({ ...post, ...updatePostDto });
        }
...
exports.PostsService = PostsService = __decorate([
    ...
    __param(4, (0, common_1.Inject)((0, common_1.forwardRef)(() => reputation_service_1.ReputationService))),
